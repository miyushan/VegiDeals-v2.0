  ...
  return (
    <>
      <Form className="login-form" onSubmit={onSubmit} method="post">
        ...
        <DropdownButton
          className="mb-3 dropdown-btn"
          title={gender}
          variant="success"
        >
          <Dropdown.Item
            onClick={() => onChangeGender("Male")}
            className="login-input-drop dropdown-btn-item"
          >
            Male
          </Dropdown.Item>
          <Dropdown.Item
        ...
        <Hint options={hintData} allowTabFill>
          <input
            className="input-with-hint mb-3 login-input"
            value={branchName}
        ...
        <Button
          href=""
          className="login-submit-btn login-input"
          type="submit"
